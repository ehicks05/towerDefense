...
{
    private static List<String> names = Arrays.asList("Merek", "Carac", "Ulric", "Tybalt", "Borin", "Sadon", "Terrowin", "Rowan",
    ...
    private static List<String> surnames = new ArrayList<>(Arrays.asList("Achard", "Addinell", "Adeney", "Aguilon", "Albelin", "Alevi", "Alis", "Altard",
            ...
            "Vitalis", "Vivers", "Viville", "Voisin", "Wadard", "Warci", "Watteau", "Werables", "Willoughby", "Wissant",
            "Ygou", "the Lightbringer", "Sunstrider", "Bronzebeard", "Wildhammer", "Windrunner", "Stormrage", "Shadowsong",
            "Greymane", "Trollbane", "Doomhammer", "Stormstout", "Grimtotem"));

    public static String generateName(Unit unit)
    {
        Random random = new Random();

        String fullName = names.get(random.nextInt(names.size())) + " " + surnames.get(random.nextInt(surnames.size()));
